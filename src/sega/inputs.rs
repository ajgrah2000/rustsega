...
impl Joystick {
    ...
    pub fn get_xp_pos(&self, vcounter:u8) -> u8 { self.x }
    pub fn read_port1(&self) -> u8 {self.port1_value}
    pub fn read_port2(&self) -> u8 {self.port2_value}

    pub fn j1_up    (&mut self, value:bool) {self.port1_value = Joystick::set_bit(self.port1_value, Joystick::PORT1_J1UP_BIT,    value);}
    pub fn j1_down  (&mut self, value:bool) {self.port1_value = Joystick::set_bit(self.port1_value, Joystick::PORT1_J1DOWN_BIT,  value);}
    pub fn j1_left  (&mut self, value:bool) {self.port1_value = Joystick::set_bit(self.port1_value, Joystick::PORT1_J1LEFT_BIT,  value);}
    pub fn j1_right (&mut self, value:bool) {self.port1_value = Joystick::set_bit(self.port1_value, Joystick::PORT1_J1RIGHT_BIT, value);}
    pub fn j1_fire_a(&mut self, value:bool) {self.port1_value = Joystick::set_bit(self.port1_value, Joystick::PORT1_J1FIREA_BIT, value);}
    pub fn j1_fire_b(&mut self, value:bool) {self.port1_value = Joystick::set_bit(self.port1_value, Joystick::PORT1_J1FIREB_BIT, value);}
    pub fn j2_up    (&mut self, value:bool) {self.port1_value = Joystick::set_bit(self.port1_value, Joystick::PORT1_J2UP_BIT,    value);}
    pub fn j2_down  (&mut self, value:bool) {self.port1_value = Joystick::set_bit(self.port1_value, Joystick::PORT1_J2DOWN_BIT,  value);}
    pub fn j2_left  (&mut self, value:bool) {self.port2_value = Joystick::set_bit(self.port2_value, Joystick::PORT2_J2LEFT_BIT,  value);}
    pub fn j2_right (&mut self, value:bool) {self.port2_value = Joystick::set_bit(self.port2_value, Joystick::PORT2_J2RIGHT_BIT, value);}
    pub fn j2_fire_a(&mut self, value:bool) {self.port2_value = Joystick::set_bit(self.port2_value, Joystick::PORT2_J2FIREA_BIT, value);}
    pub fn j2_fire_b(&mut self, value:bool) {self.port2_value = Joystick::set_bit(self.port2_value, Joystick::PORT2_J2FIREB_BIT, value);}
    pub fn reset    (&mut self, value:bool) {self.port2_value = Joystick::set_bit(self.port2_value, Joystick::PORT2_RESET_BIT,   value);}
    ...
    pub fn port_read(&mut self, _clock: &clocks::Clock, port_address: u8) -> Option<u8> {
        match port_address {
            ...
            _ => { None /* Unhandled, just return 0 for now */ }
        }
    }
}
...
impl Input {
    ...
    pub fn handle_events(event:event::Event, joystick:&mut Joystick) -> bool {
        match event {
            ...
            event::Event::KeyDown { keycode: Some(Input::KEY_FIRE_A), .. } => { joystick.j1_fire_a(false); }
            event::Event::KeyDown { keycode: Some(Input::KEY_FIRE_B), .. } => { joystick.j1_fire_b(false); }
            ...
            event::Event::KeyUp { keycode: Some(Input::KEY_FIRE_A), .. } => { joystick.j1_fire_a(true); }
            event::Event::KeyUp { keycode: Some(Input::KEY_FIRE_B), .. } => { joystick.j1_fire_b(true); }
